...
<section class="panel even theme-paper stack-section layout-split">
  <div class="stack gap-xl">
    ...
    <div class="stack gap-l readable">
      ...
      <p>And, to that note — for we know how it feels to sit on projects that, by their very nature, will never be finished — here's a thought we'd like to set free.</p>
