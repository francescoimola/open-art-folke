...
<section id="intro" class="panel full-bleed stack-section half split theme-brand" style="--gap: var(--vs-l);">
...
<section class="panel theme-crimson full-bleed stack-section split" style="--gap: var(--vs-l);">
  <div class="fc readable">
