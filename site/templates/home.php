...
<section class="theme-paper stack-section layout-split">
  <div class="split vertical panel even" style="--gap: var(--vs-l);">
    <div class="stack fc readable" style="--gap: var(--vs-xl);">
      <h2>
...
<section class="theme-blush stack-section half split panel even vertical" style="--gap: var(--vs-xxl);">
  <div class="stack fc readable" style="--gap: var(--vs-l);">
    <?php $days = $page->daysRemaining() ?>
    <h2>There <?= $days === 1 ? 'is' : 'are' ?> <?= $days ?> day<?= $days === 1 ? '' : 's' ?> until the next edition of Open Art Folke</h2>
    <p>Some things, as you know, just take time</p>
  </div>
  <?php snippet('countdown') ?>
</section>

<section class="theme-brand stack-section layout-split">
  <img src="/assets/images/visitors-reading-map.jpg" alt="" class="image-cover" aria-hidden="true">
  <div class="split vertical panel" style="--gap: var(--vs-l);">
    <h2>Looking for the festival Programme?<br><span style="color: var(--fg-6)">You’re early</span></h2></div>
